...
LOG=BASE/'update_1801_install.log'
ERR=BASE/'update_1801_error.txt'
...
def main():
    try:
        ...
        if 'PZ_WORD_CSHARP_COM_BRIDGE_V1801' not in mod:
            raise RuntimeError('Funktionspruefung nach Installation fehlgeschlagen.')
        LOG.write_text('OK: Update 1.8.1 erfolgreich installiert.\n',encoding='utf-8')
        try: ERR.unlink()
        ...
        try: LOG.write_text('FEHLER bei Update 1.8.1:\n'+text,encoding='utf-8')
        except Exception: pass
        return 1
