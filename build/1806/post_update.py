...
VENDOR = BASE / '_vendor'
LOG = BASE / 'update_1806_install.log'
ERR = BASE / 'update_1806_error.txt'
REQUIRED = (
    BASE / 'app.py',
    BASE / 'wordforms_v1700.py',
    BASE / 'pdf_stamp_v1860.py',
